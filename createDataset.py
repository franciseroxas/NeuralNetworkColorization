...
for i in range(1, 1005):
    for j in range(6, 15):
        ...
        try:
            ...
            newHeight = int(img.shape[1] / img.shape[0] * 256)
            newWidth = 256
            if(newHeight <= 256):
                newWidth = int(img.shape[0] / img.shape[1] * (256+128)) + 256
                newHeight = 256+128
            img = cv2.resize(img, dsize = (newHeight, newWidth), interpolation=cv2.INTER_AREA)
        ...
        for k in range(10):
            ...
            try:
                ...
                croppedImg = img[randHeight:randHeight+256, 0:256, :]
